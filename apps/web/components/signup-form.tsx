      ...
      <FieldGroup>
        <div className="flex flex-col items-center gap-1 text-center">
          ...
          <p className="text-sm text-balance text-muted-foreground">
            Join Summit Forms and start building beautiful forms
          </p>
        </div>
        <Field>
        ...
        <Field>
          ...
          <FieldDescription className="px-6 text-center">
            ...
            <a href="/login" className="text-primary hover:text-primary/80 underline-offset-4 hover:underline">Sign in</a>
          </FieldDescription>
        </Field>
      </FieldGroup>
    </form>
